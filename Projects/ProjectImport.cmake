...
FUNCTION(ImportProject ProjectName)
    ...
    if(NOT IMPORT_PROJECT_BIT)
        ...
        set(WORKING_DIRECTORY_SUFFIX "${WORKING_DIRECTORY_SUFFIX}_${IMPORT_PROJECT_BIT}")
    endif()
    ...
    if(NOT IMPORT_PROJECT_EXTERNAL_DIR_CACHE)
        if(IMPORT_PROJECT_EXTERNAL_DIR)
            cmake_path(
                ABSOLUTE_PATH IMPORT_PROJECT_EXTERNAL_DIR
                BASE_DIRECTORY ${CMAKE_SOURCE_DIR}
                NORMALIZE
                OUTPUT_VARIABLE IMPORT_PROJECT_EXTERNAL_DIR
                )
        else()
            set(IMPORT_PROJECT_EXTERNAL_DIR ${CMAKE_SOURCE_DIR}/external)
            cmake_path(NORMAL_PATH IMPORT_PROJECT_EXTERNAL_DIR)
        endif()
        set(IMPORT_PROJECT_EXTERNAL_DIR_CACHE ${IMPORT_PROJECT_EXTERNAL_DIR} CACHE INTERNAL "")
    endif()

    set(WORKING_DIRECTORY ${IMPORT_PROJECT_EXTERNAL_DIR_CACHE}/${ProjectName_Lower}${WORKING_DIRECTORY_SUFFIX})
